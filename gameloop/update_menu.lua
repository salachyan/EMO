function _update()
    ...
    if screen == "level" then
        ...
        --     load("prologue.p8")
        -- end
        if color_outline_lvl1==8 and btn(❎, 0) then
            load("level1.p8")
        end
        if color_outline_lvl2==8 and btn(❎, 0) then
            load("level2.p8")
        end
        if color_outline_lvl3==8 and btn(❎, 0) then
            load("level3.p8")
        end
        if color_outline_boulder==8 and btn(❎, 0) then
            load("climax.p8")
        end
        if color_outline_menu_lvl==8 and btn(❎, 0) then
            map_offset_x=0
            map_offset_y=0
        end
    end
